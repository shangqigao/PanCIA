...
from analysis.a05_outcome_prediction.domain_adaptation import (
    DomainAdaptationTransformer,
    DomainAdaptationVAE,
    DomainAdaptedSurvivalPipeline,
)
from analysis.a05_outcome_prediction.contextual_bandit import (
    AdaptiveWeightedCoxPLLoss,
    BayesianWeightedCoxPLLoss,
    ContextualBandit,
    ContextualBanditPipeline,
    EnsembleWeightedCoxPLLoss,
    PolicyNetwork,
    TorchCoxPH,
    WeightedCoxPLLoss,
)
from analysis.a05_outcome_prediction.variational_survival_moe import (
    ...
    ConditionalVariationalSurvivalPipeline,
)
...
class SurvivalAnalyzer:
    ...
    def strategy_6_EM_Contextual_Bandit(self, split, split_idx, omics_params, model_params):
        ...
        bandit = ContextualBandit(
            ...
            exploration_weight=model_params.get('exploration_weight', 0.2),
    ...
    def strategy_7_variational_survival_moe(self, split, split_idx,
        ...
        without access to survival outcomes.
        ...
        """
        print(f"\n=== Strategy 7: Bayesian Survival Mixture ===")
        ...
        # New statistically coherent conditional latent mixture. Reliability
        # is an explicit prior and must be supplied independently (for example,
        # from prior folds); the default is deliberately non-informative.
        bandit = ConditionalVariationalSurvivalMoE(
            ...
            router_state_mode=model_params.get(
                'variational_router_state', 'full_uncertainty_knn'
            ),
