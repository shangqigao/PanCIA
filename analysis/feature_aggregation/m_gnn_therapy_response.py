...
class TherapyGraphDataset(Dataset):
    """loading graph data for response to therapy
    """
...
class TherapyGraphArch(nn.Module):
...
class TherapyBayesGraphArch(nn.Module):
    """define Bayesian Graph architecture for response to therapy
    """
    def __init__(
            self, 
            dim_features, 
