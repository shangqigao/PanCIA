...
datasets = [
    ...
    'Prostate_Tumor',
    'Uterus_Tumor',
    'Bladder_Tumor+Background', 
    'Breast_Tumor+Background', 
    'Cervix_Tumor+Background', 
    'Colon_Tumor+Background',
    'Kidney_Tumor+Background',
    'Liver_Tumor+Background',
    'Lung_Tumor+Background',
    'Ovary_Tumor+Background',
    'Pancreas_Tumor+Background',
    'Prostate_Tumor+Background',
    'Uterus_Tumor+Background',
